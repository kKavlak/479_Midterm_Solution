...
namespace MVC.Controllers
{
    public class StudentsController : Controller
    {
        ...
        {
            StudentModel student = _studentService.Query().SingleOrDefault(s => s.StudentId == id); // TODO: Add get item service logic here
            if (student == null)
            {
                return NotFound();
            }
        ...
        public IActionResult Create(StudentModel student)
        {
            if (ModelState.IsValid)
            {
                ...
                ModelState.AddModelError("", "Error - No Students Added!");
            }
            // TODO: Add get related items service logic here to set ViewData if necessary and update null parameter in SelectList with these items
            ViewData["GradeId"] = new SelectList(_gradeService.Query().ToList(), "Id", "Year");
            return View(student);
        ...
        public IActionResult Edit(StudentModel student)
        {
            if (ModelState.IsValid)
            {
                ...
                ModelState.AddModelError("", "Error - No updates made!");
            }
            // TODO: Add get related items service logic here to set ViewData if necessary and update null parameter in SelectList with these items
            ViewData["GradeId"] = new SelectList(_gradeService.Query().ToList(), "Id", "Year");
            return View(student);
